...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/brs_utils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14038&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/brs_utils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `brs_utils` can be installed with:

```
conda install brs_utils
```

It is possible to list all of the versions of `brs_utils` available on your platform with:
